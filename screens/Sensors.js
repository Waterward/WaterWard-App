...
const renderComponent = (title, tankId, mqttClient) => {
  switch (title) {
    case 'Water Level':
      return <WaterLevel tankId={tankId} mqttClient={mqttClient} />;
    case 'Temperature':
      return <Temperature tankId={tankId} mqttClient={mqttClient} />;
    case 'PH':
      return <PH tankId={tankId} mqttClient={mqttClient} />;
    case 'TDS (Total Dissolved Solids)':
      return <TDS tankId={tankId} mqttClient={mqttClient} />;
    case 'Turbidity':
      return <Turbidity tankId={tankId} mqttClient={mqttClient} />;
    case 'Water Flow':
      return <WaterFlow tankId={tankId} mqttClient={mqttClient} />;
    case 'Control Tank Valve':
      return <Valve tankId={tankId} mqttClient={mqttClient} />;
    case 'Control Tank Motor':
      return <Motor tankId={tankId} mqttClient={mqttClient} />;
    case 'Add WaterWard Hub':
      return <Hub mqttClient={mqttClient} />;
    default:
